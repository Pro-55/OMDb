...
class ListPresenterImpl(iListPresenterImpl: IListPresenterImpl) {
    ...
    fun callSearchApi(searchBoxText: String, page: Int, itemCount: Int) {
        if (totalCount!!.toInt() > itemCount) {
                    ...
                    .subscribe(object : ApiSuccess<SearchResult>() {
                        override fun call(searchResult: SearchResult) {
                            if (searchResult.response == "True") {
                                ...
                                listPresenterImplInterface!!.successSearchResult(searchResult.searchData)
